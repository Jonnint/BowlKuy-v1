<x-guest-layout>
    <div class="mb-8 text-center">
        ...
        <p class="text-gray-400 text-sm mt-2">Buat akun untuk mulai memesan Rice Bowl favoritmu.</p>
    </div>
    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <!-- Name -->
        <div>
            <x-input-label for="name" :value="__('Nama')" class="text-gray-300 font-semibold" />
        ...
        <!-- Confirm Password -->
        <div class="mt-5">
            <x-input-label for="password_confirmation" :value="__('Konfirmasi Password')" class="text-gray-300 font-semibold" />
        ...
        <div class="mt-6 text-center text-sm text-gray-400">
            Sudah punya akun? 
            <a href="{{ route('login') }}" class="text-yellow-400 hover:text-yellow-300 font-bold underline transition">
                Masuk Sekarang
            </a>
        </div>
    </form>
